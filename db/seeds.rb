...
r1 = Recipe.create(name: "Dirt Bomb Muffin", description: "A cinnamon sugar coated donut that's actually a muffin!", instructions: "Heat oven to 400°. Grease three 6-cup muffin tins with butter; set aside.
...
r3 = Recipe.create(name: "Black and White Brownies", description: "Three layered brownie that is the definition of decadence", instructions: "
    ...
    MAKES ABOUT 2 CUPS/13.2 OUNCES/375 GRAMS
    ...
    ")
r4 = Recipe.create(name: "Monkey Bread", description: "A savory and herbalicious tear and share loaf", instructions: "Combine the flour, yeast, and sugar in the bowl of a stand mixer.
    ...
    ")
r5 = Recipe.create(name: "Chocolate Cupackes and Vanilla Frosting", description: "Moist and rich chocolate cupcakes with vanilla frosting make for a classic pairing", instructions:"Cupcakes
    ...
    " )
r6 = Recipe.create(name: "Cheddar Herb Biscuits", description: "Buttermilk Biscuits with a cheesey twist!", instructions: "Preheat the oven to 450 degrees F. and grease or spray a cast-iron skillet with cooking spray.
